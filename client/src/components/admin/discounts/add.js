...
const AddDiscount = ({ code, setCode, discountAmount, setDiscountAmount, discountType, setDiscountType, minimumSpend, setMinimumSpend, notes, setNotes, isUnique, setIsUnique, addDiscount  }) => {
    ...
    return (
        <div className={`${style.container} ml-6 width100`}>
            ...
            <div className='is-flex is-justify-content-end'>
                <button className="button" onClick={() => addDiscount()}>Save</button>
