...
const AddMessage = ({ content, setContent, type, setType, textColor, setTextColor, textPosition, setTextPosition, textWeight, setTextWeight, backgroundUrl, setBackgroundUrl, visibility, setVisibility, setShowPreview, addMessage }) => {
        ...
        <div className={`boxShadow ml-6 is-flex p-6 ${style.displayColumn}`}>
            <div className={`${style.container} ml-6 width100`}>
                ...
                <div className='is-flex is-justify-content-end mt-6'>
                    ...
                    <button className="button ml-2" onClick={() => addMessage()}>Save</button>
